@php
    $targetA = new \shafi0313\LaravelFormComponents\Tests\Feature\TranslatableModel();
    $targetA->setTranslations('input', ['nl' => 'hallo', 'en' => 'hello']);

    $targetB = new \shafi0313\LaravelFormComponents\Tests\Feature\TranslatableModel();
